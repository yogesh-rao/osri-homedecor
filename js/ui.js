...
function headerHTML() {
  ...
  return `
    <div class="announce">
      Free shipping across India on orders over <b>${money(STORE.freeShipOver)}</b> &nbsp;·&nbsp;
      Use code <b>${STORE.promo.code}</b> for ${STORE.promo.percent}% off
    </div>
    <header class="site-header">
      <div class="wrap header-bar">
        ...
        <div class="header-actions">
          ...
          <button class="icon-btn" aria-label="Account" onclick="toast('Accounts are not wired up in this demo')">${ICONS.user}</button>
